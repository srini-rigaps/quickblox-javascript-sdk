    ...
    // $(function() {
        ...
        var recModule = {
            ...
            handleDataAvailable: function(e) {
                recModule.recordedBlobs.push(e.data);
            },
            download: function() {
                var blob = new Blob(recModule.recordedBlobs, {type: 'video/webm'}),
                    ...
                    if (err) {
                        ...
                        app.currentSession.call({}, function(error) {
                            if(error) {
                                ...
                                if(document.querySelector('input[name="record_check"]:checked')) {
                                    recModule.userId = +document.querySelector('input[name="record_check"]:checked').value;
                                }
        ...
        if (!QB.webrtc) {
            ...
            QB.webrtc.onRemoteStreamListener = function(session, userID, stream) {
                ...
                if(recModule.userId && window.MediaRecorder) {
                    recModule.mediaRecorder = new window.MediaRecorder(stream, 'video/vp8');
                    recModule.mediaRecorder.start(10);
                    recModule.mediaRecorder.ondataavailable = recModule.handleDataAvailable;
                }
            ...
            QB.webrtc.onSessionConnectionStateChangedListener = function(session, userID, connectionState) {
                ...
                if(connectionState === QB.webrtc.SessionConnectionState.CLOSED){
                    ...
                    if(+userID === recModule.userId) {
                        recModule.mediaRecorder.stop();
                        recModule.download();
                    }
